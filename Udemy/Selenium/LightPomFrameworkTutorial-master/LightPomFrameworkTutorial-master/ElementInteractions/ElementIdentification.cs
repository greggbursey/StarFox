...
namespace ElementInteractions
{
    ...
    public class ElementIdentification
    {
        ...
        public void ElementIdentificationTest()
        {
            ...
            var idElement = driver.FindElement(By.Id("button1"));
            idElement.Click();
            driver.Navigate().Back();

            var classElement = driver.FindElement(By.ClassName("buttonClass"));
            classElement.Click();
            driver.Navigate().Back();

            var nameElement = driver.FindElement(By.Name("button1"));
            nameElement.Click();
            driver.Navigate().Back();

            var linkElement = driver.FindElement(By.LinkText("Click this link"));
            linkElement.Click();
            driver.Navigate().Back();
